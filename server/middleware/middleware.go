...
import (
	...
	"github.com/lunarwhite/todo-app/server/models"
...
const connectionString = "mongodb://localhost:27017" // for localhost
const dbName = "test"                                // database name
const collName = "todolist"                          // collection name

var collection *mongo.Collection // collection object/instance
